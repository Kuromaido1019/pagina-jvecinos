...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Creacion Acta de Reunion</title>
</head>
...
<body>
    ...
    <div class="container" style="margin-top:2%; margin-bottom:8%;">
        <form action="../../../controles/Actas/Controles_Actas.php?flag=1" method="post">
            <div class="row">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="col s2">
                                    ...
                                    <input placeholder="Ingrese id de la directiva" id="txtIdDirectiva"
                                ...
                                <div class="col s3">
                                    ...
                                    <input placeholder="Ingrese titulo de la Acta" id="txtTitulo"
                                        name="txtTitulo" type="text">
                                </div>
                                <div class="col s12">
