...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Creacion Tipo Documento</title>
</head>
...
<body>
    ...
    <div class="container" style="margin-top:2%; margin-bottom:8%;">
        <form action="../../../controles/Documentos/Control_Documentos.php?flag=2" method="post">
            <div class="row">
                <!-- Datos del Formulario -->
                <div class="col s5">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title center-align"><b>Crear un tipo de Documento</b></span>
                            <div class="divider" style="margin-bottom:3%;"></div>
                            <!-- Input del Tipo de Documento -->
                            <label for="txtNombre">Nombre del Tipo Documento</label>
                            <input placeholder="Ingrese nombre del tipo documento" id="txtNombre" name="txtNombre"
                                type="text">
                        </div>
                        <div class="card-action center-align teal darken-4">
                            <input type="submit" value="Crear Tipo Documento"
                ...
                <div class="col s6">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title center-align"><b>Listado de Documentos Registrados</b></span>
                            <div class="divider" style="margin-bottom:3%;"></div>
                            <table class="highlight striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../../../controles/Documentos/Control_Documentos.php?id=<?php echo $row['Id_Tipo_Documento'] ?>" class="waves-effect waves-light btn red darken-4">
