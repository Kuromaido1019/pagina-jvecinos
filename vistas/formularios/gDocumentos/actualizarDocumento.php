...
<body>
    ...
    <div class="container" style="margin-top:2%; margin-bottom:10%;">
        <form action="../../../controles/Documentos/Control_Documentos.php?flag=3" method="post">
            <div class="row">
                <!-- Datos del Formulario -->
                <div class="col s5">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title center-align"><b>Actualizar un tipo de Documento</b></span>
                            <div class="divider" style="margin-bottom:3%;"></div>
                            <!-- Input del Id de Documento -->
                            <label for="txtId">Id del Documento</label>
                            <input placeholder="Ingrese ID del documento" id="txtId" name="txtId"
                                type="text">
                ...
                <div class="col s6">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="divider" style="margin-bottom:3%;"></div>
                            <table class="highlight striped center">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Descripcion</th>                                                                               
