...
<?php
    ...
    $con = conectar();
    $_SESSION['TipoUsuario'] = "Vecino2";
    $sql = "SELECT * FROM Avisos WHERE Run_Integrante = '".$_SESSION['Run_Integrante']."'";
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Edicion de Noticia</title>
</head>
...
<body>
    ...
    <div class="container" style="margin-top:2%; margin-bottom:8%;">
        <form action="../../../controles/Noticias/Controles_Noticias.php?flag=2" method="post" enctype="multipart/form-data">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="row">
                                 <!-- Input del Id Aviso -->
                                 <div class="col s3">                                    
                                    <label for="txtId">Id Aviso</label>
                                    <input placeholder="Ingrese id del aviso" id="txtId" name="txtId" type="text">
                                </div>
                        ...
                        <div class="card-action center-align teal darken-4">
                            <input type="submit" value="Editar Aviso" class="waves-effect waves-light btn-small  teal darken-1"
