...
<body>
    ...
    <div class="container" style="margin-top:2%; margin-bottom:8%;">
        <form action="../../../controles/Cargos/Control_Cargos.php?flag=3" method="post">
            <div class="row">
                <!-- Datos del Formulario -->
                <div class="col s5">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title center-align"><b>Editar un Cargo</b></span>
                            <div class="divider" style="margin-bottom:3%;"></div>
                            <!-- Input del Id Cargo -->
                            <label for="txtId">Id del Cargo</label>
                            <input placeholder="Ingrese id cargo" id="txtId" name="txtId"
                                type="text">
                                <!-- Input del Nombre Cargo -->
