...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Edicion de Credenciales</title>
</head>
...
<body>
    ...
    <div class="container" style="margin-top:2%; margin-bottom:11.5%;">
        <form action="../../../controles/Accesos/Control_Acceso.php?flag=2" method="post">
            <div class="row">
                ...
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="row">
                            <div class="col s3">
                                    <!-- Input del Id Usuario -->
                                    <label for="txtId">Id del Usuario</label>
                                    <input placeholder="Ingrese id del Usuario" id="txtId" name="txtId" type="text">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col s3">
